...
internal sealed class TokenizerRejectableTrailing<T> : LexerTokenizer<T>
	where T : struct
{
	/// <summary>
	/// 接受符号的堆栈。
	...
	public TokenizerRejectableTrailing(LexerData<T> lexerData, LexerController<T> controller) :
