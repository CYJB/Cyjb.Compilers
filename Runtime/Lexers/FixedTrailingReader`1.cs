...
internal sealed class FixedTrailingReader<T> : TokenlizerBase<T>
	where T : struct
{
	/// <summary>
	...
	public FixedTrailingReader(LexerData<T> lexerData, LexerController<T> controller, SourceReader reader) :
